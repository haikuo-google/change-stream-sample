...
public interface Options extends DataflowPipelineOptions {
  ...
  @Description(
    "The start timestamp used to fetch from change stream.")
  ...
  @Description("Spanner tables to read change stream (comma separator), must be a subset of tables tracked by change stream.")
  @Default.String("")
  String getSpannerTableNames();

  void setSpannerTableNames(String value);
  ...
  @Default.String("{_metadata_spanner_internal_table_name}_changelog")
